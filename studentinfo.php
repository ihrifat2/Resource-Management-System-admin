...
//Getting all the student info from DB
$studentInfoData = array();
$studentInfoQuery = "SELECT * FROM `tbl_userinfo` WHERE `userinfo_role` = 0 ORDER BY `userinfo_id` DESC";
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        ?>
                                        <td><a class='btn btn-primary' onclick='deletestudent(<?php echo $studentInfoRow['userinfo_id']; ?>)' href='#'>Block</a></td>
                                        <?php
                                        } else {
                                        ?>
                                        <td><a class='btn btn-primary' onclick='deletestudent(<?php echo $studentInfoRow['userinfo_id']; ?>)' href='#'>Unblock</a></td>
                                        <?php
                                        }
                                        ?>
                                    </tr>
